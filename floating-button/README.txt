...
= 6.0.1 =
* Fixed: security bug related to item deactivation.

= 6.0 =
* Added: two new size: small, large
* Added: hover icon color
* Added: close icon for main button
* Added: Link to the respective page for each item, enhancing navigation
* Updated: FontAwesome Icon now on up-to-date version 6.4.2
* Changed: Admin Interface improved for better user-friendliness and intuitive usage
...
* Added: option 'Attribute: class' to link
* Added: option 'Attribute: ID' to link
* Added: tooltip for main button
* Added: Activate/deactivate menu
* Added: test mode
