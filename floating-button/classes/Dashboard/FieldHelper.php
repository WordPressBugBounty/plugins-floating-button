...
class FieldHelper {
	...
	public static function site_menus(): array {

		$menus_obj = wp_get_nav_menus( array( 'hide_empty' => false, 'orderby' => 'name' ) );
		$all_menus = [];
		if ( count( $menus_obj ) > 0 ) {
			foreach ( $menus_obj as $value ) {
				$all_menus[ $value->term_id ] = $value->name;
			}
		} else {
			$all_menus[] = __( 'Menus not created yet', 'floating-button' );
		}

		return $all_menus;
	}

	public static function btn_self_anim(): array {
		return [
			''             => __( 'None', 'floating-button' ),
			'fa-beat'      => __( 'Beat', 'floating-button' ),
			'fa-fade'      => __( 'Fade', 'floating-button' ),
			'fa-beat-fade' => __( 'Beat-Fade', 'floating-button' ),
			'fa-bounce'    => __( 'Bounce', 'floating-button' ),
			'fa-flip'      => __( 'Flip', 'floating-button' ),
			'fa-shake'     => __( 'Shake', 'floating-button' ),
			'fa-spin'      => __( 'Spin', 'floating-button' ),
		];
	}
	...
	public static function gtranslate(): array {
		return [
			'af'  => esc_attr__( 'Afrikaans', 'floating-button' ),
			'sq'  => esc_attr__( 'Albanian', 'floating-button' ),
			'am'  => esc_attr__( 'Amharic', 'floating-button' ),
			'ar'  => esc_attr__( 'Arabic', 'floating-button' ),
			'hy'  => esc_attr__( 'Armenian', 'floating-button' ),
			'az'  => esc_attr__( 'Azerbaijani', 'floating-button' ),
			'eu'  => esc_attr__( 'Basque', 'floating-button' ),
			'be'  => esc_attr__( 'Belarusian', 'floating-button' ),
			'bn'  => esc_attr__( 'Bengali', 'floating-button' ),
			'bs'  => esc_attr__( 'Bosnian', 'floating-button' ),
			'bg'  => esc_attr__( 'Bulgarian', 'floating-button' ),
			'ca'  => esc_attr__( 'Catalan', 'floating-button' ),
			'ceb' => esc_attr__( 'Cebuano', 'floating-button' ),
			'ny'  => esc_attr__( 'Chichewa', 'floating-button' ),
			'co'  => esc_attr__( 'Corsican', 'floating-button' ),
			'hr'  => esc_attr__( 'Croatian', 'floating-button' ),
			'cs'  => esc_attr__( 'Czech', 'floating-button' ),
			'da'  => esc_attr__( 'Danish', 'floating-button' ),
			'nl'  => esc_attr__( 'Dutch', 'floating-button' ),
			'en'  => esc_attr__( 'English', 'floating-button' ),
			'eo'  => esc_attr__( 'Esperanto', 'floating-button' ),
			'et'  => esc_attr__( 'Estonian', 'floating-button' ),
			'tl'  => esc_attr__( 'Filipino', 'floating-button' ),
			'fi'  => esc_attr__( 'Finnish', 'floating-button' ),
			'fr'  => esc_attr__( 'French', 'floating-button' ),
			'fy'  => esc_attr__( 'Frisian', 'floating-button' ),
			'gl'  => esc_attr__( 'Galician', 'floating-button' ),
			'ka'  => esc_attr__( 'Georgian', 'floating-button' ),
			'de'  => esc_attr__( 'German', 'floating-button' ),
			'el'  => esc_attr__( 'Greek', 'floating-button' ),
			'gu'  => esc_attr__( 'Gujarati', 'floating-button' ),
			'ht'  => esc_attr__( 'Haitian Creole', 'floating-button' ),
			'ha'  => esc_attr__( 'Hausa', 'floating-button' ),
			'haw' => esc_attr__( 'Hawaiian', 'floating-button' ),
			'iw'  => esc_attr__( 'Hebrew', 'floating-button' ),
			'hi'  => esc_attr__( 'Hindi', 'floating-button' ),
			'hmn' => esc_attr__( 'Hmong', 'floating-button' ),
			'hu'  => esc_attr__( 'Hungarian', 'floating-button' ),
			'is'  => esc_attr__( 'Icelandic', 'floating-button' ),
			'ig'  => esc_attr__( 'Igbo', 'floating-button' ),
			'id'  => esc_attr__( 'Indonesian', 'floating-button' ),
			'ga'  => esc_attr__( 'Irish', 'floating-button' ),
			'it'  => esc_attr__( 'Italian', 'floating-button' ),
			'ja'  => esc_attr__( 'Japanese', 'floating-button' ),
			'jw'  => esc_attr__( 'Javanese', 'floating-button' ),
			'kn'  => esc_attr__( 'Kannada', 'floating-button' ),
			'kk'  => esc_attr__( 'Kazakh', 'floating-button' ),
			'km'  => esc_attr__( 'Khmer', 'floating-button' ),
			'ko'  => esc_attr__( 'Korean', 'floating-button' ),
			'ku'  => esc_attr__( 'Kurdish (Kurmanji)', 'floating-button' ),
			'ky'  => esc_attr__( 'Kyrgyz', 'floating-button' ),
			'lo'  => esc_attr__( 'Lao', 'floating-button' ),
			'la'  => esc_attr__( 'Latin', 'floating-button' ),
			'lv'  => esc_attr__( 'Latvian', 'floating-button' ),
			'lb'  => esc_attr__( 'Luxembourgish', 'floating-button' ),
			'mk'  => esc_attr__( 'Macedonian', 'floating-button' ),
			'mg'  => esc_attr__( 'Malagasy', 'floating-button' ),
			'ms'  => esc_attr__( 'Malay', 'floating-button' ),
			'ml'  => esc_attr__( 'Malayalam', 'floating-button' ),
			'mt'  => esc_attr__( 'Maltese', 'floating-button' ),
			'mi'  => esc_attr__( 'Maori', 'floating-button' ),
			'mr'  => esc_attr__( 'Marathi', 'floating-button' ),
			'mn'  => esc_attr__( 'Mongolian', 'floating-button' ),
			'my'  => esc_attr__( 'Myanmar (Burmese)', 'floating-button' ),
			'ne'  => esc_attr__( 'Nepali', 'floating-button' ),
			'no'  => esc_attr__( 'Norwegian', 'floating-button' ),
			'ps'  => esc_attr__( 'Pashto', 'floating-button' ),
			'fa'  => esc_attr__( 'Persian', 'floating-button' ),
			'pl'  => esc_attr__( 'Polish', 'floating-button' ),
			'pt'  => esc_attr__( 'Portuguese', 'floating-button' ),
			'pa'  => esc_attr__( 'Punjabi', 'floating-button' ),
			'ro'  => esc_attr__( 'Romanian', 'floating-button' ),
			'ru'  => esc_attr__( 'Russian', 'floating-button' ),
			'sm'  => esc_attr__( 'Samoan', 'floating-button' ),
			'gd'  => esc_attr__( 'Scottish Gaelic', 'floating-button' ),
			'sr'  => esc_attr__( 'Serbian', 'floating-button' ),
			'st'  => esc_attr__( 'Sesotho', 'floating-button' ),
			'sn'  => esc_attr__( 'Shona', 'floating-button' ),
			'sd'  => esc_attr__( 'Sindhi', 'floating-button' ),
			'si'  => esc_attr__( 'Sinhala', 'floating-button' ),
			'sk'  => esc_attr__( 'Slovak', 'floating-button' ),
			'sl'  => esc_attr__( 'Slovenian', 'floating-button' ),
			'so'  => esc_attr__( 'Somali', 'floating-button' ),
			'es'  => esc_attr__( 'Spanish', 'floating-button' ),
			'su'  => esc_attr__( 'Sudanese', 'floating-button' ),
			'sw'  => esc_attr__( 'Swahili', 'floating-button' ),
			'sv'  => esc_attr__( 'Swedish', 'floating-button' ),
			'tg'  => esc_attr__( 'Tajik', 'floating-button' ),
			'ta'  => esc_attr__( 'Tamil', 'floating-button' ),
			'te'  => esc_attr__( 'Telugu', 'floating-button' ),
			'th'  => esc_attr__( 'Thai', 'floating-button' ),
			'tr'  => esc_attr__( 'Turkish', 'floating-button' ),
			'uk'  => esc_attr__( 'Ukrainian', 'floating-button' ),
			'ur'  => esc_attr__( 'Urdu', 'floating-button' ),
			'uz'  => esc_attr__( 'Uzbek', 'floating-button' ),
			'vi'  => esc_attr__( 'Vietnamese', 'floating-button' ),
			'cy'  => esc_attr__( 'Welsh', 'floating-button' ),
			'xh'  => esc_attr__( 'Xhosa', 'floating-button' ),
			'yi'  => esc_attr__( 'Yiddish', 'floating-button' ),
			'yo'  => esc_attr__( 'Yoruba', 'floating-button' ),
			'zu'  => esc_attr__( 'Zulu', 'floating-button' ),
		];
	}

	public static function share_services() {
		return [
			'facebook'         => __( 'Facebook', 'floating-button' ),
			'vk'               => __( 'VK', 'floating-button' ),
			'twitter'          => __( 'Twitter', 'floating-button' ),
			'linkedin'         => __( 'Linkedin', 'floating-button' ),
			'odnoklassniki'    => __( 'Odnoklassniki', 'floating-button' ),
			'google'           => __( 'Google', 'floating-button' ),
			'pinterest'        => __( 'Pinterest', 'floating-button' ),
			'xing'             => __( 'XING', 'floating-button' ),
			'myspace'          => __( 'Myspace', 'floating-button' ),
			'weibo'            => __( 'Weibo', 'floating-button' ),
			'buffer'           => __( 'Buffer', 'floating-button' ),
			'stumbleupon'      => __( 'StumbleUpon', 'floating-button' ),
			'reddit'           => __( 'Reddit', 'floating-button' ),
			'tumblr'           => __( 'Tumblr', 'floating-button' ),
			'blogger'          => __( 'Blogger', 'floating-button' ),
			'livejournal'      => __( 'LiveJournal', 'floating-button' ),
			'pocket'           => __( 'Pocket', 'floating-button' ),
			'telegram'         => __( 'Telegram', 'floating-button' ),
			'skype'            => __( 'Skype', 'floating-button' ),
			'email'            => __( 'Email', 'floating-button' ),
			'draugiem'         => __( 'Draugiem', 'floating-button' ),
			'whatsapp'         => __( 'Whatsapp', 'floating-button' ),
			'diaspora'         => __( 'Diaspora', 'floating-button' ),
			'digg'             => __( 'Digg', 'floating-button' ),
			'douban'           => __( 'Douban', 'floating-button' ),
			'evernote'         => __( 'Evernote', 'floating-button' ),
			'flipboard'        => __( 'Flipboard', 'floating-button' ),
			'google-bookmarks' => __( 'Google Bookmarks', 'floating-button' ),
			'hacker-news'      => __( 'Hacker News', 'floating-button' ),
			'instapaper'       => __( 'Instapaper', 'floating-button' ),
			'line'             => __( 'Line', 'floating-button' ),
			'qzone'            => __( 'Qzone', 'floating-button' ),
			'renren'           => __( 'Renren', 'floating-button' ),
		];
	}
	...
	public static function icons() {
		$icons = [
			...
			'fab fa-pixelfed',
			'fab fa-square-figma',
			'fab fa-square-linkedin',
			'fab fa-tex',
			'fab fa-tidal',
			'fab fa-vsco',
			'fab fa-w3c',
			'fas fa-bus-side',
			'fas fa-mobile-vibrate',
			'fas fa-non-binary',
			'fas fa-pentagon',
			'fas fa-septagon',
			'fas fa-single-quote-left',
			'fas fa-spiral',
			'fas fa-single-quote-right',
		];
	...
	public static function btn_position() {
		return [
	...
	public static function btn_shape() {
		return [
			'flBtn-shape-circle'  => __( 'Circle', 'floating-button' ),
		];
	}

	public static function btn_size() {
		return [
	...
	public static function btn_self_animation() {
		return [
			''                 => __( 'None', 'floating-button' ),
			'flBtn-bounce'     => __( 'Bounce', 'floating-button' ),
			'flBtn-flash'      => __( 'Flash', 'floating-button' ),
			'flBtn-pulse'      => __( 'pulse', 'floating-button' ),
			'flBtn-rubberBand' => __( 'rubberBand', 'floating-button' ),
			'flBtn-shake'      => __( 'shake', 'floating-button' ),
			'flBtn-headShake'  => __( 'headShake', 'floating-button' ),
			'flBtn-swing'      => __( 'swing', 'floating-button' ),
			'flBtn-tada'       => __( 'tada', 'floating-button' ),
			'flBtn-wobble'     => __( 'wobble', 'floating-button' ),
			'flBtn-jello'      => __( 'jello', 'floating-button' ),
			'flBtn-heartBeat'  => __( 'heartBeat', 'floating-button' ),
		];
	}

	public static function btn_animation() {
		return [
			''                                    => __( 'Fade', 'floating-button' ),
		];
	}

	public static function btn_shadow() {
		return [
	...
	public static function user_roles(): array {
		$add_users      = array( 'all' => array( 'name' => __( 'All Users', 'floating-button' ) ) );
